        ...
        <React.Fragment>
            <Container>
                <Row>
                    ...
                    <Col md={8}>
                        ...
                        <p className="mt-2 ml-2"><b>Genre:</b> {movie.category}</p>
                        <p className="mt-2 ml-2"><b>Directed by:</b> {movie.director}</p>
            ...
            <Modal show={rate} onClose={closeRate}>
                <Modal.Body>
                    ...
                    <div>
                        <Button
                            variant={rating === 1 ? "primary" : "outline-success"}
                        ...
                        <Button
                            variant={rating === 2 ? "warning" : "outline-success"}
                        ...
                        <Button
                            variant={rating === 3 ? "dark" : "outline-success"}
                        ...
                        <Button
                            variant={rating === 4 ? "info" : "outline-success"}
